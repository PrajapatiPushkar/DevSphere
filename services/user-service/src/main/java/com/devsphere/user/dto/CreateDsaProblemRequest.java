...
public class CreateDsaProblemRequest {
    ...
    public CreateDsaProblemRequest() {
    }

    public CreateDsaProblemRequest(String title, String description, DsaPlatform platform, String problemUrl, DsaDifficulty difficulty, DsaTopic topic, Integer timeSpentMinutes, String notes, Long taskId, Long goalId) {
        this.title = title;
