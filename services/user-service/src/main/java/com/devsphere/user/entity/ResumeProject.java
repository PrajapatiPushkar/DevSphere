...
@Entity
@Table(name = "resume_projects", uniqueConstraints = {
    @UniqueConstraint(name = "uk_resume_projects_proj", columnNames = {"resume_profile_id", "project_id"})
})
public class ResumeProject {
    ...
    public ResumeProject(Long resumeProfileId, Long projectId, Integer displayOrder) {
