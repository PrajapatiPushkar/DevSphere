...
public class ResumeCompilationController {
    ...
    public ResumeCompilationController(ResumeCompilationService resumeCompilationService) {
        this.resumeCompilationService = resumeCompilationService;
    }

    @GetMapping("/{resumeId}/compile")
    public ResponseEntity<CompiledResumeResponse> compileResume(
        ...
        CompiledResumeResponse response = resumeCompilationService.compileResume(resumeId, userId);
