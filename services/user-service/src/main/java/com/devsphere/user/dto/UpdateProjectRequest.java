...
public class UpdateProjectRequest {
    ...
    public UpdateProjectRequest(String name, String description, ProjectType projectType, String repositoryUrl, String liveUrl, String documentationUrl, List<String> techStack, LocalDate startDate, LocalDate targetEndDate) {
        this.name = name;
