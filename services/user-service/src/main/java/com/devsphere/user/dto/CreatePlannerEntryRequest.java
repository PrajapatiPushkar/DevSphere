...
public class CreatePlannerEntryRequest {
    ...
    public CreatePlannerEntryRequest() {
    }

    public CreatePlannerEntryRequest(Long taskId, LocalDate plannedDate, LocalTime startTime, LocalTime endTime, Integer plannedMinutes, Integer sortOrder) {
        this.taskId = taskId;
