...
@Entity
@Table(name = "resume_educations", uniqueConstraints = {
    @UniqueConstraint(name = "uk_resume_educations_edu", columnNames = {"resume_profile_id", "education_id"})
})
public class ResumeEducation {
    ...
    public ResumeEducation(Long resumeProfileId, Long educationId, Integer displayOrder) {
